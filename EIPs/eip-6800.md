...
A witness only contains the fragments of the state data that are required to execute the transactions in the block

This is because the witness is a path connecting the data, which is held in leaves, to the root hash.
